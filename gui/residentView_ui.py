...
class Ui_UsersWindow(object):
    ...
    def retranslateUi(self, UsersWindow):
        UsersWindow.setWindowTitle(QCoreApplication.translate("UsersWindow", u"Display resident information", None))
        self.labelFname.setText(QCoreApplication.translate("UsersWindow", u"Name", None))
        ...
        self.labelNum.setText(QCoreApplication.translate("UsersWindow", u"License plate", None))
        self.labelCarModel.setText(QCoreApplication.translate("UsersWindow", u"Vehicle type", None))
        self.labelPlateNum.setText(QCoreApplication.translate("UsersWindow", u"License plate \u062e\u0648\u062f\u0631\u0648", None))
